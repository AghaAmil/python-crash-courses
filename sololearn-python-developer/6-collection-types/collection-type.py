...
"""
Lesson 6 - Summary (Data Structure)
...
When to use the other types: - Use lists if you have a collection of data that does not need random access. Try to 
...
Note: Sets does not allow duplicate values.
"""
